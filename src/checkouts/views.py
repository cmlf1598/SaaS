...
def checkout_finalize_view(request):
    ...
    try:
        sub_obj = Subscription.objects.get(subscriptionprice__stripe_id=plan_id) # related lookup
    except:
        sub_obj = None
    try:
        user_obj = User.objects.get(customer__stripe_id=customer_id) # related lookup
    except:
        user_obj = None
